...
const Nemo = memo(({ id, index, nemo, moveNemo, someDragging, setSomeDragging }) => {
	// 드래그
	...
	return (
		<div
			ref={previewRef} //previewRef  처음에는 프리뷰와 dropRef 이곳에 지정했다.
			style={{ opacity: isDragging ? '0.3' : '1' }}
		>
			{' '}
			//드래그중인 아이템의 투명도를 30%로 주었다.
			...
			//dropRef 좀 더 자연스러운 ux를 구현하기 위해서 dropRef를 두개로 나누었다. //아래 두 dropRef는
			absolutef로 네모의 왼쪽 오른쪽에 배치.
			<div
				ref={dropLeft}
